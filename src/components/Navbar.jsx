    ...
    return (
        <>
            ...
            <nav ref={navRef} className="w-full fixed px-5 lg:px-8 xl:px-[8%] py-4 flex items-center justify-between z-50">
                ...
                <ul ref={navLinkRef} className="hidden md:flex items-center gap-6 lg:gap-8 rounded-sm px-12 py-3 bg-white shadow-sm bg-opacity-50 font-Ovo dark:border dark:border-white/30 dark:bg-transparent ">
                ...
                <div className="flex items-center gap-4">
                    ...
                    <a href="#contact" className="hidden lg:flex items-center gap-3 px-8 py-1.5 border border-gray-300 hover:bg-slate-100/70 dark:hover:bg-darkHover rounded-sm ml-4 font-Ovo dark:border-white/30">
                        Contact
