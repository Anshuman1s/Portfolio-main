export default function Services() {
    ...
    return (
        <div id="services" className="w-full px-[12%] py-10 scroll-mt-20">
            ...
            <p className="text-center max-w-2xl mx-auto mt-5 mb-12 font-Ovo">Frontend developer skilled in building responsive and user-friendly web applications using HTML, CSS, JavaScript, and React.
Passionate about creating clean UI, solving real-world problems, and continuously improving development skills.</p>
